...
public class ProductServiceImpl implements ProductService {
    ...
    public Product createProduct(ProductDTO productDTO) {
        ...
        product.setDiscountPrice(productDTO.getDiscountPrice() != null ? productDTO.getDiscountPrice().doubleValue() : null);
    ...
    public Product updateProduct(Long id, ProductDTO productDTO) {
        ...
        if (productDTO.getDiscountPrice() != null) {
            product.setDiscountPrice(productDTO.getDiscountPrice().doubleValue());
        }
